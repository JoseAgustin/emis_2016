...
!
! ifort -O2 -axAVX -lnetcdff -L$NETCDF/lib -I$NETCDF/include g_mozart_2016.f90 -o mozart.exe
!
!
...
!   Es actualiza para anio 2016             10/11/2019
!
module varsm
...
subroutine lee
	...
	data fnameA /'TACO__2016.csv','TANOx_2016.csv','TANOx_2016.csv','TANH3_2016.csv','TASO2_2016.csv',&
	...
	data fnameM /'TMCO__2016.csv','TMNO_2016.csv','TMNO2_2016.csv','TMNH3_2016.csv','TMSO2_2016.csv',&
