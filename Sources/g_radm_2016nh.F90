...
!
! ifort g_radm_2016nh.f90 -O2 -axAVX -lnetcdff -L$NETCDF/lib -I$NETCDF/include -o radm2h.exe
!
!
...
subroutine lee
	...
	data fnameM /'TMCO__2016.csv','TMNH3_2016.csv','TMNO_2016.csv','TMNO2_2016.csv','TMSO2_2016.csv',&
