...
!  / _ \ '_ ` _ \| / __/ __| |/ _ \| '_ \/ __|   / __|/ _` \ \ / / _ \   | '_ \ / __|
! |  __/ | | | | | \__ \__ \ | (_) | | | \__ \   \__ \ (_| |\ V /  __/   | | | | (__
!  \___|_| |_| |_|_|___/___/_|\___/|_| |_|___/___|___/\__,_| \_/ \___|___|_| |_|\___|
!                                           |_____|                 |_____|
...
subroutine setup_mecha
    ...
    case("ghg")
        ...
        fnameP=(/'T_ANNCO2.csv     ','GHG_CH4_P.txt    ','T_ANNCH4.csv     '/)
        isp=[ 1 ,2 ]
        WTM=(/44.,16./)
...
!     Define dimensiones
    ...
    call check( nf90_put_att(ncid, NF90_GLOBAL, "CEN_LAT",xlat(nx/2,ny/2+1)))
    call check( nf90_put_att(ncid, NF90_GLOBAL, "CEN_LON",xlon(nx/2+1,ny/2)))
    call check( nf90_put_att(ncid, NF90_GLOBAL, "TRUELAT1",17.5))
    call check( nf90_put_att(ncid, NF90_GLOBAL, "TRUELAT2",29.5))
    call check( nf90_put_att(ncid, NF90_GLOBAL, "MOAD_CEN_LAT",xlat(nx/2,ny/2+1)))
    call check( nf90_put_att(ncid, NF90_GLOBAL, "STAND_LON",xlon(nx/2+1,ny/2)))
    ...
    call check( nf90_put_att(ncid, nf90_global, "NUM_LAND_CAT",24))
...
!  ___ ___  _ __  _   _  __   ____ _| |   / |___ \| |_ ___|___ \|___ /
! / __/ _ \| '_ \| | | | \ \ / / _` | |   | | __) | __/ _ \ __) | |_ \
!| (_| (_) | |_) | |_| |  \ V / (_| | |   | |/ __/| || (_) / __/ ___) |
! \___\___/| .__/ \__, |___\_/ \__,_|_|___|_|_____|\__\___/_____|____/
!          |_|    |___/_____|        |_____|
